...
let section = document.querySelector('#asteroid')
section.innerHTML += "<strong>Asteroid Name: </strong>" + asteroid.name + "<br>";
section.innerHTML += "<strong>Potentially Hazardous: </strong>" + asteroid.is_potentially_hazardous_asteroid + "<br>";
section.innerHTML += "<strong>Close Approach Data:<stong><br>";
section.innerHTML += "<em>Miss Distance: </em>" + asteroid.close_approach_data[0].miss_distance.miles + " miles <br>";
section.innerHTML += "<em>Relative Velocity: </em>" + asteroid.close_approach_data[0].relative_velocity.miles_per_hour + " miles/hour <br>";
section.innerHTML += '<strong>More Info: </strong><a href="' + asteroid.nasa_jpl_url + '">Click Here</a><br>';